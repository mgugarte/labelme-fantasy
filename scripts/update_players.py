...
for t in teams:
    ...
    for p in players:
        ...
        ON DUPLICATE KEY UPDATE
            ...
            team_id=IF(VALUES(partidos) >= partidos, VALUES(team_id), team_id),
            team_name=IF(VALUES(partidos) >= partidos, VALUES(team_name), team_name),
            team_logo=IF(VALUES(partidos) >= partidos, VALUES(team_logo), team_logo),
